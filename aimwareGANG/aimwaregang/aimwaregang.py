...
if choice.lower() == 'y' or choice.lower() == 'yes':
        ...
        try:
            ...
            print(f"{Fore.RED}Your Python Version is Not supported: ({sys.version_info[0]}.{sys.version_info[1]}.{sys.version_info[2]}), Please Download v3.9+ to use AIMWARE!{Fore.RESET}")
            sleep(5)
...
try:
    ...
    with open('data/logins.json', 'w') as f:
            print(f"\n[{g}#\x1b[95m\x1B[37m] Logging Into AIMWARE")
...
def spammer():
    ...
    Write.Print("                                     /$$__  $$|_  $$_/| $$$    /$$$| $$  /$ | $$ /$$__  $$| $$__  $$| $$_____/ \n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                     | $$  \ $$  | $$  | $$$$  /$$$$| $$ /$$$| $$| $$  \ $$| $$  \ $$| $$$\n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                     | $$$$$$$$  | $$  | $$ $$/$$ $$| $$/$$ $$ $$| $$$$$$$$| $$$$$$$/| $$$$$\n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                     | $$__  $$  | $$  | $$  $$$| $$| $$$$_  $$$$| $$__  $$| $$__  $$| $$__/\n", Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [v{THIS_VERSION}]                          | $$  | $$  | $$  | $$\  $ | $$| $$$/ \  $$$| $$  | $$| $$  \ $$| $$\n', Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [AIMWare]                         | $$  | $$ /$$$$$$| $$ \/  | $$| $$/   \  $$| $$  | $$| $$  | $$| $$$$$$$$\n', Colors.purple_to_blue, interval=0.000)
    Write.Print(" > [https://discord.gg/VqU9v6RsgQ]   |__/  |__/|______/|__/     |__/|__/     \__/|__/  |__/|__/  |__/|________/\n", Colors.purple_to_blue, interval=0.000)
...
#   ABOUT
    if choice == '30':
        Spinner()
        setTitle(f"About    |    ")
        Write.Print("\nHello, thanks for using GANG-Nuker!\nif you run into any problems make sure to let me know asap!\nDiscord:Lencano#2625\nDiscord server https://discord.gg/VqU9v6RsgQ", Colors.purple_to_blue, interval=0.015)
        time.sleep(1)
        exit = input('[\x1b[95m>\x1b[95m\x1B[37m] Press ENTER: ')
        exit = clear()
        exit = spammer()
